...
f32 Math::smoothDamp(const f32 &current, const f32 &target, f32 &currentVelocity, const f32 &smoothTime, const f32 &maxSpeed, const f32 &deltaTime) {
...
f32 Math::smoothDampAngle(const f32 &current, const f32 &target, f32 &currentVelocity, const f32 &smoothTime, const f32 &maxSpeed, const f32 &deltaTime) {
